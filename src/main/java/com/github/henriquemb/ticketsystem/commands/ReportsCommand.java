...
public class ReportsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (reports.isEmpty()) {
            m.sendMessage(p, messages.getString("report.all_verified"), "report");
            return true;
        }
        ...
        if (args.length > 0) {
            try {
                ...
                m.sendMessage(p, messages.getString("pagination.error.invalid"), "report");
            }
        }
